...
var BaseService = /** @class */ (function () {
    ...
    BaseService.prototype.GetToken = function (key) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, localStorage.getItem(key)];
                    case 1:
                        token = _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
                        if (!ReactNative) return [3 /*break*/, 4];
                        return [4 /*yield*/, ReactNative.AsyncStorage.getItem(key)];
                    case 3:
                        token = _a.sent();
                        _a.label = 4;
    ...
    BaseService.prototype.VerificarAdmin = function () {
        return __awaiter(this, void 0, void 0, function () {
            var token;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    BaseService.prototype.CriarRequisicao = function (tipoRequisicao, versao, rota, data, tipoResposta) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (rota && rota !== "")
                    url = url + "/" + rota;
                return [2 /*return*/, this.CriarRequisicaoPorUrl(tipoRequisicao, url, data, tipoResposta)];
            });
        });
    };
