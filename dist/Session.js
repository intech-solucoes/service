        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, localStorage.removeItem("@" + config.appName + ":token")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, localStorage.removeItem("@" + config.appName + ":token-admin")];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    if (!ReactNative) return [3 /*break*/, 6];
                    return [4 /*yield*/, ReactNative.AsyncStorage.removeItem("@" + config.appName + ":token")];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, ReactNative.AsyncStorage.removeItem("@" + config.appName + ":token-admin")];
                case 5:
                    _a.sent();
                    _a.label = 6;
